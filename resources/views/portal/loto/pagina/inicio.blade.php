    ...
    <div id="test4">
        <div class="row">
            ...
            <div class="collection col m6 card">
                <a href="/loteria/{{$jogo->id}}" class="collection-item">{{$jogo->nome}}</a>                
            </div>
            @empty
        ...
        <div class="row">
            <form method="POST" action="/loto"class="col s12">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea id="textarea1" name="instrucao" class="materialize-textarea"></textarea>
                                <label for="textarea1">Instruções</label>
                            </div>
                        </div>
